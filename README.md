...
- [x] [辅助互动](/json/辅助互动.json)
  > 不断地点击互动键，直到主动停止脚本，可用于**辅助完成浇水、播种、种菜、收菜、采集等动作**。~~妈妈再也不用担心我得腱鞘炎~~

- [x] [辅助钓鱼](/json/辅助钓鱼.json)
  > 不断地自动钓鱼，直到主动停止脚本。请在**钓鱼点范围内**启动此脚本。

- [x] [辅助伐木林采集](/json/辅助伐木林采集.json)
  > 请在进入伐木林后（入口处）启动。此脚本**其实可以 100% 自动运行，但无法保证能够收集所有资源**，按照测试数据，保底可以收集 70%。~~宏脚本啥都好，但面对有些动态场景就显得有点笨笨的~~

- [x] [辅助摩尔拉雅采集](/json/辅助摩尔拉雅采集.json)
  > 请在**夜晚的摩尔拉雅地图**启动此脚本。*（白浆果采集点x5）X 5轮*

- [x] [辅助前哨站采集](/json/辅助钓鱼.json)
  > 请在**夜晚的前哨站地图**启动此脚本。*（黑浆果采集点x13 + 草丛x1）X 5轮*
  >
  > 剩余两个草丛距离远，而黑浆果刷新快，暂时不采集。
